module.exports = function(app) {
    ...
    return function(model) {
        ...
        var data = {
            ...
            desc : {
                en : 'Provides currency switching and related functionality. Supported currencies are defined at the bottom of the file but may be set via an API or configuration file. Use ISO 4217. If the code isn\'t set core.country will be queried to determine it. This configuration also saves the applied code using core.store.',
