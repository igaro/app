                ...
                return Promise.all(
                    ...
                    return self.addPanels(
                        ...
                        [
                            // main panel
                            {
                                title:function() { return this.tr((({ key:"Main" }))); },
                                active:true,
                                content:domMgr.mk('div',null,null,function() {
                                    ...
                                    domMgr.mk('select',this,null,function() {
                                        ...
                                        domMgr.mk('option',this,function() { return this.tr((({ key:"Style" }))); });
                                        domMgr.mk('option',this,function() { return this.tr((({ key:"Paragraph" }))); }).value = 'p';
                                        domMgr.mk('option',this,function() { return this.tr((({ key:"Heading 1" }))); }).value = 'h1';
                                        domMgr.mk('option',this,function() { return this.tr((({ key:"Heading 2" }))); }).value = 'h2';
                                        domMgr.mk('option',this,function() { return this.tr((({ key:"Heading 3" }))); }).value = 'h3';
                                        domMgr.mk('option',this,function() { return this.tr((({ key:"Heading 4" }))); }).value = 'h4';
                                        domMgr.mk('option',this,function() { return this.tr((({ key:"Heading 5" }))); }).value = 'h5';
                                        domMgr.mk('option',this,function() { return this.tr((({ key:"Heading 6" }))); }).value = 'h6';
                                        domMgr.mk('option',this,function() { return this.tr((({ key:"Formatted" }))); }).value = 'pre';
                                    });
                                    var self2 = this;
                                    var opts = [
                                        'bold',
                            ...
                            // character
                            {
                                title:function() { return this.tr((({ key:"Character" }))); },
                                content:domMgr.mk('div',null,null,function() {
                        ...
                        .concat(
                            [
                                ['backcolor', function() { return this.tr((({ key:"Backcolor" }))); }],
                                ['forecolor', function() { return this.tr((({ key:"Forecolor" }))); }],
                                ['hilitecolor', function() { return this.tr((({ key:"Highlight" }))); }]
                            ]
