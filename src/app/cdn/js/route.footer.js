...
module.exports = function(app) {
    ...
    return function(model) {
		...
		domMgr.mk('div',wrapper,[
    		domMgr.mk('span', null, function(l) { return l.gettext("License: LGPLv3"); })
    	],'license');
            ...
            objectMgr.create('xhr').then(function (xhr) {
                return xhr.get({
                    ...
                    function(data) {
                        ...
                        domMgr.mk('span',x, function(l) { return l.gettext("Updated:"); });
                ...
                return xhr.get({
                    ...
                    function(data) {
                        ...
                        return domMgr.mk('div',null,null,function() {
                            ...
                            domMgr.mk('span',this, function(l) { return l.gettext("Open Issues:"); });
